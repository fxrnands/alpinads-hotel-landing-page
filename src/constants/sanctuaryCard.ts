...
/** Display scale vs Figma — tweak here to resize cards while keeping proportion. */
export const SANCTUARY_CARD_SCALE = 1.1;

export const SANCTUARY_CARD_WIDTH = Math.round(
  SANCTUARY_CARD_DESIGN_WIDTH * SANCTUARY_CARD_SCALE,
);
export const SANCTUARY_CARD_HEIGHT = Math.round(
  SANCTUARY_CARD_DESIGN_HEIGHT * SANCTUARY_CARD_SCALE,
);
export const SANCTUARY_CARD_IMAGE_HEIGHT = Math.round(
  SANCTUARY_CARD_DESIGN_IMAGE_HEIGHT * SANCTUARY_CARD_SCALE,
);
