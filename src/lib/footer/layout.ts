...
export const FOOTER_HEADING_CLASS =
  "font-montserrat text-base font-medium leading-[140%] text-white" as const;
...
export const FOOTER_BOTTOM_CLASS =
  "font-montserrat text-base font-normal leading-[150%] text-white/70 lg:grid lg:grid-cols-2 lg:items-center lg:gap-4" as const;

export const FOOTER_COPYRIGHT_CLASS =
  "justify-self-start font-montserrat text-base font-normal leading-[150%] text-white/70" as const;

export const FOOTER_CREDIT_TEXT_CLASS =
  "font-montserrat text-base font-normal leading-[150%] tracking-normal text-white/70" as const;
