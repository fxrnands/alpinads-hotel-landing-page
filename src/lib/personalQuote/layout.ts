...
export const PERSONAL_QUOTE_DESCRIPTION_CLASS =
  "mx-auto mt-6 w-full max-w-[880px] font-manrope text-[16px] font-normal leading-[150%] tracking-normal text-white" as const;
...
export const PERSONAL_QUOTE_INPUT_CLASS =
  "min-w-0 flex-1 border-0 bg-transparent p-0 font-manrope text-[16px] font-normal leading-[150%] tracking-normal text-[#323232] outline-none placeholder:text-[#323232]/40" as const;

export const PERSONAL_QUOTE_SUBMIT_CLASS =
  "flex h-[48px] w-full items-center justify-center rounded-[8px] bg-[#A49781] px-6 font-manrope text-[16px] font-normal uppercase leading-[150%] tracking-[0.05em] text-white transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A49781]/40 focus-visible:ring-offset-2 md:inline-flex md:w-auto md:max-w-[205px]" as const;
...
export const PERSONAL_QUOTE_SELECT_TRIGGER_CLASS =
  "h-[56px] min-h-[56px] w-full rounded-[8px] border border-[#3232321A] bg-[#FAFAFA] px-4 font-manrope text-[16px] leading-[140%] shadow-none [&>svg]:size-6 [&>svg]:text-black [&>svg]:opacity-100" as const;
